...
class FloatingPointTypes
{
    static void Main()
    {
        ...
        Console.WriteLine("Float calculation: a+b={0}  expected={1}  equal={2}", a + b, expectedSum, equal);
        Console.WriteLine();
        ...
        Console.WriteLine("Double calculation: a+b={0}  expected={1}  equal={2}", sum, expectedSum, equal);
        Console.WriteLine("sum (without rounding) = " + TypeDescriptor.GetConverter(sum).ConvertTo(sum, typeof(string)));
        Console.WriteLine();
        ...
        Console.WriteLine("Decimal calculation: a+b={0}  sum={1}  equal={2}", aDecimal + bDecimal, sumDecimal, equalDecimal);
    }
}
