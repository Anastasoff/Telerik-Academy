...
class ConvertAnyNumeralSystem
{
    ...
    static List<string> ConvertFromDecimalToAny(int decimalNumber, int baseD)
    {
    ...
    static void Main()
    {
        ...
        List<string> result = ConvertFromDecimalToAny(ConvertToDecimal(number, baseS), baseD);
