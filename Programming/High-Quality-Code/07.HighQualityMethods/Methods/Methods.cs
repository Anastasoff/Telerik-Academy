namespace Methods
{
    ...
    public class Methods
    {
        ...
        public static string DigitToEnglishWord(int digit)
        {
            ...
            {
                case 0:
                    digitAsEnglishWord = "zero";
                    break;
                case 1:
                    digitAsEnglishWord = "one";
                    break;
                case 2:
                    digitAsEnglishWord = "two";
                    break;
                case 3:
                    digitAsEnglishWord = "three";
                    break;
                case 4:
                    digitAsEnglishWord = "four";
                    break;
                case 5:
                    digitAsEnglishWord = "five";
                    break;
                case 6:
                    digitAsEnglishWord = "six";
                    break;
                case 7:
                    digitAsEnglishWord = "seven";
                    break;
                case 8:
                    digitAsEnglishWord = "eight";
                    break;
                case 9:
                    digitAsEnglishWord = "nine";
                    break;
                default:
