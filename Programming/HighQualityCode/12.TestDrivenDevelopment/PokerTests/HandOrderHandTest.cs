namespace PokerTests
{
    ...
    public class HandOrderHandTest
    {
        ...
        public void TestOrderHand()
        {
            ...
            Assert.AreEqual(cardOne.Face, array[0].Face,
                "OrderHand() method in class Hand is not working correctly.");
            Assert.AreEqual(cardThree.Face, array[1].Face,
                "OrderHand() method in class Hand is not working correctly.");
            Assert.AreEqual(cardFive.Face, array[2].Face,
                "OrderHand() method in class Hand is not working correctly.");
            Assert.AreEqual(cardTwo.Face, array[3].Face,
                "OrderHand() method in class Hand is not working correctly.");
            Assert.AreEqual(cardFour.Face, array[4].Face,
                "OrderHand() method in class Hand is not working correctly.");
        }
        ...
        public void TestOrderHandSameCards()
        {
            ...
            Assert.AreEqual(cardThree.Face, array[1].Face,
                "OrderHand() method in class Hand is not working correctly.");
            Assert.AreEqual(cardTwo.Face, array[2].Face,
                "OrderHand() method in class Hand is not working correctly.");
            Assert.AreEqual(cardFour.Face, array[3].Face,
                "OrderHand() method in class Hand is not working correctly.");
            Assert.AreEqual(cardFour.Face, array[4].Face,
                "OrderHand() method in class Hand is not working correctly.");
        }
