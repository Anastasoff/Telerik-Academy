...
namespace ForumSystem.Web
{
    ...
    public static class NinjectWebCommon
    {
        ...
        {
            kernel.Bind<DbContext>().To<ForumSystemDbContext>();
            ...
            kernel.Bind(typeof(IRepository<Feedback>)).To(typeof(DeletableEntityRepository<Feedback>));

            kernel.Bind(typeof(IRepository<Vote>)).To(typeof(DeletableEntityRepository<Vote>));
