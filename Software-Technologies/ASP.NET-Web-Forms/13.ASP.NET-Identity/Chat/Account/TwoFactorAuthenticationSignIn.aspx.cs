...
namespace Chat.Account
{
    public partial class TwoFactorAuthenticationSignIn : System.Web.UI.Page
    {
        ...
        {
            var userId = signinManager.GetVerifiedUserId<ChatUser, string>();
            if (userId == null)
            {
        ...
        protected void CodeSubmit_Click(object sender, EventArgs e)
        {
            ...
            var result = signinManager.TwoFactorSignIn<ChatUser, string>(SelectedProvider.Value, Code.Text, isPersistent: rememberMe, rememberBrowser: RememberBrowser.Checked);
            switch (result)
            {
        ...
        protected void ProviderSubmit_Click(object sender, EventArgs e)
        {
            ...
            var user = manager.FindById(signinManager.GetVerifiedUserId<ChatUser, string>());
            if (user != null)
            {
