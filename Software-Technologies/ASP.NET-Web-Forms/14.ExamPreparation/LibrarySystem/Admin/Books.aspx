<%@ Page Title="Books" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Books.aspx.cs" Inherits="LibrarySystem.Admin.Books" %>
        ...
        <ContentTemplate>
            <asp:FormView runat="server" ID="FormViewInsertBook" DefaultMode="Insert"
                ...
                <InsertItemTemplate>
                    ...
                    <div>
                        <span>Category:</span>
                        <asp:DropDownList runat="server" ID="DropDownListCategoriesCreate" DataTextField="Name" DataValueField="ID" ItemType="LibrarySystem.Models.Category" SelectedValue="<%#: BindItem.Id %>" SelectMethod="DropDownListCategoriesCreate_GetData">
                        </asp:DropDownList>
                    </div>
                    <asp:LinkButton runat="server" ID="LinkButtonCreate" CssClass="link-button" Text="Create" CommandName="Insert" />
                    <asp:LinkButton runat="server" ID="LinkButtonCancel" CssClass="link-button" Text="Cancel" CommandName="Cancel" PostBackUrl="~/Admin/Books.aspx" />
                </InsertItemTemplate>
            </asp:FormView>
        </ContentTemplate>
    </asp:UpdatePanel>
